        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="/images/footer-logo1.png" alt=""></div>
                    <div class="about-content">Данный сайт разработан для ознакомления с 
                        косметической продукцией. На нем публикуются правдивые и реальные отзывы
                        о товарах. Также вы можете задавать дополнительные вопросы авторам постов.
                    </div>
                    <div class="address">
                        ...
                        <p> Телефон: +38 044 444 44 44 </p>

                        <p> kochura@gmail.com </p>
                    </div>
                </aside>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2020 <a href="#">Blog, </a> Designed with <i
                            class="fa fa-heart"></i> by <a href="#">Victoria Kochura</a>
                    </div>
                </div>
            </div>
        </div>
